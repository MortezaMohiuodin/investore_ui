...
<template>
  <header class="relative z-10 h-20 items-center border-b">
    <div
      class="relative z-10 mx-auto flex h-full flex-col justify-center px-3 text-white"
    >
      <div class="relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2">
        ...
        <div class="container relative left-0 flex w-3/4">
          ...
          >
            ...
            <svg
              class="pointer-events-none absolute left-0 ml-4 hidden h-4 w-4 fill-black text-gray-100 group-hover:text-gray-400 sm:block"
            ...
            <input
              type="text"
              class="block w-full rounded-2xl bg-white dark:bg-gray-700 dark:text-white py-1.5 pl-10 pr-4 leading-normal text-black opacity-90 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Search"
            />
          </div>
        </div>
